...
<div class="main-slid-img">
    <div class="slid-img">
	<video src="Videos/ahemdabad.mp4" muted autoplay loop></video>
        <div class="intro">
                <h1>Ahmedabad: A tapestry of colors,<br> culture, and culinary delights.</h1>
...
document.addEventListener('DOMContentLoaded', function() {
      ...
      textBox2.value = 'Ahmedabad, Gujarat';
    });
    </script>
...
<div class="ahemdabad-content">
	<div class="amd-city-main">
			<h1>
				Book a flight to Ahemdabad with Us
			</h1>
			<div class="sub-amd">
				<p>
					<br><br>
					Ahmedabad, the largest city in the state of Gujarat, India, is a vibrant metropolis brimming with history, culture, and modernity. Nestled on the banks of the Sabarmati River, Ahmedabad is renowned for its rich heritage, architectural marvels, and bustling markets that offer a glimpse into the city's illustrious past.
				  <br><br>

					One of Ahmedabad's most iconic landmarks is the Sabarmati Ashram, the former residence of Mahatma Gandhi and the nucleus of India's freedom struggle. Visitors can explore the serene surroundings where Gandhi lived and worked, gaining insights into his philosophy of non-violence and Satyagraha.
				  <br><br>

					The city's architectural splendors are showcased in its numerous heritage sites, including the intricate carvings of the Adalaj Stepwell and the grandeur of the Sidi Saiyyed Mosque's latticework windows. Each monument tells a story of Ahmedabad's rich history and cultural diversity.
				 
				</p>
				
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d92571.37747405947!2d72.51714193885252!3d23.02917406629871!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e848aba5bd449%3A0x4fcedd11614f6516!2sAhmedabad%2C%20Gujarat!5e1!3m2!1sen!2sin!4v1710177757755!5m2!1sen!2sin" width="500" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
				</iframe>
			</div>
			...
			<div>
				...
				<p style="margin:20px 100px; font-size:18px;">
					<center> Ahmedabad's vibrant markets, such as the bustling lanes of Law Garden and the historic Manek Chowk, offer a treasure trove of handicrafts, textiles, and traditional artifacts. Exploring these markets provides visitors with an immersive experience of the city's colorful culture and vibrant street life.</center>
				</p>

				<br><br><br>
				<iframe width="100%" height="500" src="https://www.youtube.com/embed/vcXQ43k-JBg" title="Ahmedabad City - गुजरात का सबसे विकसित शहर 🇮🇳 | अहमदाबाद शहर" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
			</div>

			<div class="sub-amd">
				<p><center>
					<br><br>
				Ahmedabad is a city that seamlessly blends tradition with modernity, offering visitors a captivating journey through time and culture. With its rich heritage, architectural marvels, mouthwatering cuisine, and bustling markets, Ahmedabad promises a memorable experience for every traveler.
				</center>
				</p>
			</div>
