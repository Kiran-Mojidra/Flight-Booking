...
<div class="main-slid-img">
    <div class="slid-img">
	<video src="Videos/ooty.mp4" muted autoplay loop></video>
        <div class="intro">
                <h1>Ooty: Queen of Hill Stations," <br> enchants with its scenic beauty<br> and  pleasant climate.</h1>
                        ...
                        <ul class="option2" id="toOptions" name="to1">
                           ...
                           <li>
                                    <div class="makeFlex hrtlCenter">
                                        <img class="icLocAlt appendRight8" src="Icons/ic-flight-onward.png" alt="icon">
                                        <div class="calc60">
                                            <p class="font14 appendBottom5 blackText">Ooty, Tamil Nadu</p>
                                            <p class="font12 greyText appendBottom3"> Rajkot Airport</p>
                                        </div>
                                        <div class="pushRight font14 lightGreyText latoBold con">RAJ</div>
                                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
      ...
      textBox2.value = 'Ooty, Tamil Nadu';
    });
...
<div class="ahemdabad-content">
	<div class="amd-city-main">
			...
			<div class="sub-amd">
				<p>
					<br><br>
					Nestled amidst the Nilgiri Hills in southern India, Ooty, also known as Udhagamandalam, captivates travelers with its enchanting natural beauty and serene ambiance. Renowned as the "Queen of Hill Stations," Ooty offers a refreshing escape from the hustle and bustle of city life. The picturesque landscapes adorned with lush tea plantations, dense forests, and rolling hills create a postcard-perfect setting that soothes the soul.

                    <br><br>
                    Visitors to Ooty are greeted with a pleasant climate year-round, making it an ideal destination for those seeking respite from the scorching heat of the plains. The cool mountain air, coupled with the aroma of eucalyptus trees, invigorates the senses and beckons travelers to unwind and rejuvenate amidst nature's embrace.

                    <br><br>
                    One of Ooty's main attractions is the Nilgiri Mountain Railway, a UNESCO World Heritage Site, offering a scenic journey through winding tracks, verdant valleys, and cascading waterfalls. The toy train ride provides a nostalgic glimpse into the region's colonial past and offers panoramic views of the surrounding countryside.				 
				</p>
				
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30391.268422956273!2d76.67282109628752!3d11.411849727067876!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba8bd84b5f3d78d%3A0x179bdb14c93e3f42!2sOoty%2C%20Tamil%20Nadu!5e1!3m2!1sen!2sin!4v1710265954797!5m2!1sen!2sin" width="600" height="590" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>				</iframe>
			</div>

			<div>
				<h1> <center>Ooty highlights</center> </h1>
				...
				<br><br><br>
                <iframe width="100%" height="530" src="https://www.youtube.com/embed/AnLs2FMITco" title="Top 10 Tourist Places to Visit in Ooty, Tamil Nadu" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>			</div>

			<div class="sub-amd">
				<p><center>
					<br><br>
                    Ooty's timeless charm, coupled with its scenic beauty and cultural heritage, makes it a must-visit destination for travelers seeking tranquility, adventure, and cultural enrichment amidst nature's bounty.				</center>
				</p>
			</div>
      ...
      <div class="card_outer2">
        ...
        <div class="card2">
          <div class="content2">
            ...
            <p class="copy2">Discover the soul of Gujarat in the bustling streets of Ahmedabad.</p>
