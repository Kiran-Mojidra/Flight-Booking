...
<div class="main-slid-img">
    <div class="slid-img">
	<video src="Videos/jaisalmer.mp4" muted autoplay loop></video>
        <div class="intro">
                <h1>Jaisalmer: The Golden City of Rajasthan,<br> adorned with sandstone architectur.</h1>
...
document.addEventListener('DOMContentLoaded', function() {
      ...
      textBox2.value = 'Jaisalmer,Rajasthan';
    });
...
<div class="ahemdabad-content">
	<div class="amd-city-main">
			<h1>
				Book a flight to Jaisalmer with Us
			</h1>
			<div class="sub-amd">
				<p>
					<br><br>
          Nestled amidst the golden sands of the Thar Desert, Jaisalmer, famously known as the "Golden City," boasts a rich tapestry of history, culture, and natural beauty. Dominating the skyline is the majestic Jaisalmer Fort, a UNESCO World Heritage Site and one of the few living forts in the world. Its intricately carved sandstone facades, labyrinthine alleys, and ornate palaces narrate tales of valor and grandeur from centuries past.

          <br><br>
          Beyond the fort's walls lie the charming streets of the old city, adorned with exquisitely carved Havelis showcasing the opulent lifestyle of the erstwhile merchants. Patwon ki Haveli, Salim Singh ki Haveli, and Nathmal ki Haveli are among the most renowned, each adorned with unique architectural marvels.

          <br><br>
          Jaisalmer's allure extends beyond its architectural splendor, beckoning adventurers to explore the vast expanse of the Thar Desert. Embark on a mesmerizing camel safari through the undulating dunes of the Sam Sand Dunes, where the shifting sands create an ever-changing landscape. As the sun sets over the horizon, casting hues of orange and gold across the desert sky, witness the ethereal beauty of nature unfold before your eyes.
				</p>
				
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d56927.96081860334!2d70.85353043696317!3d26.90357282278752!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3947bc28aa1b396b%3A0xf5ef9bd660d66ee3!2sJaisalmer%2C%20Rajasthan%20345001!5e0!3m2!1sen!2sin!4v1710334919431!5m2!1sen!2sin" width="600" height="650" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>				</iframe>
			</div>

			<div>
				<h1> <center>Jaisalmer highlights</center> </h1>

				<p style="margin:20px 100px; font-size:18px;">
					<center> 
          Immerse yourself in the vibrant culture of Rajasthan with traditional folk music and dance performances under the starlit sky. Indulge your taste buds in the flavors of authentic Rajasthani cuisine, from spicy curries to delectable sweets, served with warm hospitality in local eateries and desert camps.
          </center>
				</p>

				<br><br><br>
        <iframe width="100%" height="530" src="https://www.youtube.com/embed/vFapg7KmvKw" title="Jaisalmer, Rajasthan, India  [Amazing Places 4K]" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
          <br>
        <center>
        Whether wandering through the narrow lanes of the fort, gazing at the mesmerizing sunset over the dunes, or delving into the rich cultural tapestry of the region, Jaisalmer offers an enchanting journey through time and tradition, leaving an indelible mark on every traveler's heart.				
        </center>
				</p>
			</div>
	...
	<section class="container2">
      <div class="card_outer2">
        <div class="card2">
          <div class="content2">
            <h2 class="title2">Goa</h2>
            <p class="copy2">Portuguese colonial architecture and historic churches.</p>
            <button class="btn2"><a href="Goa.php">Read More</a></button>
          </div>
        </div>
        <div class="card2">
          <div class="content2">
        ...
        <div class="card2">
          <div class="content2">
            <h2 class="title2">Agra</h2>
            <p class="copy2"> Witness the grandeur of Agra Fort, a symbol of Mughal architecture.</p>
            <button class="btn2"><a href="Agra.php">Read More</a></button>
          </div>
        </div>
		<div class="card2">
          <div class="content2">
            <h2 class="title2">Chennai</h2>
            <p class="copy2">Discover the rich history and colonial heritage at Fort St. George, the oldest English fortress in India.</p>
            <button class="btn2"><a href="Chennai.php">Read More</a></button>
          </div>
        </div>
      </div>
    </section>
