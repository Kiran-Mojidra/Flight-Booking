...
<div class="main-slid-img">
    <div class="slid-img">
        <video src="Videos/delhi.mp4" muted autoplay loop></video>
        <div class="intro">
                <h1>Delhi: Explore the historic Red Fort,<br> an iconic symbol of India's rich Mughal heritage.</h1>
                        ...
                        <ul class="option2" id="toOptions" name="to1">
                           ...
                           <li>
                                    <div class="makeFlex hrtlCenter">
                                        <img class="icLocAlt appendRight8" src="Icons/ic-flight-onward.png" alt="icon">
                                        <div class="calc60">
                                            <p class="font14 appendBottom5 blackText">Palam, Delhi</p>
                                            <p class="font12 greyText appendBottom3">Indira Gandhi International Airport</p>
                                        </div>
                                        <div class="pushRight font14 lightGreyText latoBold con">DEL</div>
                                    </div>
                                </li>
...
<div class="ahemdabad-content">
	<div class="amd-city-main">
			<h1>
				Book a flight to Delhi with Us
			</h1>
			<div class="sub-amd">
				<p>
					<br><br>
					Delhi, the capital city of India, is a vibrant tapestry of history, culture, and modernity. Steeped in centuries of rich heritage, this dynamic metropolis offers a captivating blend of ancient monuments, bustling markets, and cosmopolitan lifestyle.

                    <br><br>
                    At the heart of Delhi lies the magnificent Red Fort, a UNESCO World Heritage Site and an enduring symbol of India's Mughal legacy. Its imposing red sandstone walls stand as a testament to the grandeur of bygone eras, inviting visitors to delve into the pages of history. Nearby, Chandni Chowk, Delhi's bustling bazaar, beckons with its maze-like lanes teeming with life, offering a sensory feast of sights, sounds, and aromas.

                    <br><br>
                    Amidst the modern skyline, Delhi boasts architectural marvels like the Lotus Temple, a serene oasis of white petals dedicated to unity and equality. India Gate, a solemn monument honoring the nation's fallen heroes, stands tall as a reminder of sacrifice and valor.			 
				</p>
				
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d217678.78166177106!2d76.92837077645729!3d28.643684629983724!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfd5b347eb62d%3A0x37205b715389640!2sDelhi!5e1!3m2!1sen!2sin!4v1710340551973!5m2!1sen!2sin" width="600" height="550" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>			</div>

			<div>
				<h1> <center>Delhi highlights</center> </h1>

				<p style="margin:20px 100px; font-size:18px;">
					<center>
                    Delhi's cultural landscape is as diverse as its populace, with institutions like Akshardham Temple showcasing the country's rich spiritual traditions, and the National Museum preserving its artistic heritage. From the majestic Qutub Minar to the serene gardens of Humayun's Tomb, every corner of Delhi tells a story of grandeur and resilience.
                    </center>        
                </p>

				<br><br><br>
                <iframe width="100%" height="530" src="https://www.youtube.com/embed/JW1jSINTzaw" title="New Delhi - Modern and Beautiful Delhi 2022 | Capital of india" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
			<div class="sub-amd">
				<p><center>
					<br><br>
                    In Delhi, every street, monument, and market is a testament to the city's vibrant spirit, inviting travelers to immerse themselves in its rich tapestry of sights, sounds, and flavors. Whether exploring its historic landmarks, savoring its culinary delights, or simply soaking in its bustling ambiance, Delhi promises an unforgettable journey through the heart and soul of India.                </center>
				</p>
			</div>
      ...
      <div class="card_outer2">
        ...
        <div class="card2">
          <div class="content2">
            ...
            <p class="copy2">Experience the allure of the Thar Desert with camel safaris and desert camping.</p>
