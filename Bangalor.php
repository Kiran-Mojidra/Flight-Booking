...
<div class="main-slid-img">
    <div class="slid-img">
	<video src="Videos/bangalore.mp4" muted autoplay loop></video>
        <div class="intro">
                <h1>Bangalore: Known as the Silicon Valley <br> of India, is a hub for technology<br> and innovation.</h1>
...
document.addEventListener('DOMContentLoaded', function() {
      ...
      textBox2.value = 'Bengaluru, Karnataka';
    });
...
<div class="ahemdabad-content">
	<div class="amd-city-main">
			<h1>
				Book a flight to Bangalore with Us
			</h1>
			<div class="sub-amd">
				<p>
					<br><br>
					Bangalore, often referred to as the Silicon Valley of India, is a dynamic metropolis that seamlessly blends its rich cultural heritage with rapid technological advancements. Renowned for its vibrant atmosphere and cosmopolitan lifestyle, Bangalore attracts visitors from all corners of the globe. 
                    
                    <br><br>
                    One of the city's defining features is its lush greenery, earning it the nickname "Garden City." Sprawling parks like Cubbon Park and Lalbagh Botanical Garden offer serene retreats amidst the urban bustle, making them popular spots for leisurely strolls and picnics.

                    <br><br>
                 Beyond its natural beauty, Bangalore is celebrated for its thriving tech industry and entrepreneurial spirit. It serves as the headquarters for numerous multinational corporations and startups, contributing significantly to India's economic growth. The city's impressive skyline is dotted with gleaming skyscrapers, a testament to its status as a major IT hub. However, Bangalore's charm extends beyond its corporate facade, as it also boasts a rich cultural tapestry shaped by its diverse population.				 
				</p>
				
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d241721.38811299697!2d77.46612635126417!3d12.953945614274408!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1670c9b44e6d%3A0xf8dfc3e8517e4fe0!2sBengaluru%2C%20Karnataka!5e1!3m2!1sen!2sin!4v1710271366525!5m2!1sen!2sin" width="600" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </iframe>
			</div>

			<div>
				<h1> <center>Bangalore highlights</center> </h1>

				<p style="margin:20px 100px; font-size:18px;">
					<center> History buffs can explore Bangalore's storied past through its many historical landmarks, including the majestic Bangalore Palace and the iconic Tipu Sultan's Summer Palace. Each site offers a glimpse into the city's royal heritage and colonial legacy, providing a fascinating journey through time.</center>
				</p>

				<br><br><br>
                <iframe width="100%" height="530" src="https://www.youtube.com/embed/eEr56MfFP6I" title="Bengaluru, (Bangalore), India 🇮🇳 in 4K 60FPS ULTRA HD HDR Drone Video (Silicon Valley of India)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>

			<div class="sub-amd">
				<p><center>
					<br><br>
                    Bangalore is a city of contrasts, where tradition and modernity coexist harmoniously. Whether you're captivated by its technological prowess, enchanted by its natural beauty, or immersed in its vibrant culture, Bangalore promises an unforgettable experience for travelers seeking to discover the heart and soul of India's dynamic urban landscape.				</center>
				</p>
			</div>
