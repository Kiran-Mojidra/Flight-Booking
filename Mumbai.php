...
<div class="main-slid-img">
    <div class="slid-img">
        <video src="Videos/mumbai.mp4" muted autoplay loop></video>
        <div class="intro">
                <h1>Mumbai: Witness the city's skyline <br> adorned with towering skyscrapers <br> and architectural marvels.</h1>
...
document.addEventListener('DOMContentLoaded', function() {
      ...
      textBox2.value = 'Mumbai,Maharashtra';
    });
...
<div class="ahemdabad-content">
	<div class="amd-city-main">
			<h1>
				Book a flight to Mumbai with Us
			</h1>
			<div class="sub-amd">
				<p>
					<br><br>
					Mumbai, often referred to as the "City of Dreams," is a bustling metropolis that captivates visitors with its vibrant energy, rich history, and diverse culture. Situated on the western coast of India, this coastal city is a melting pot of traditions, cuisines, and lifestyles. One of Mumbai's most iconic landmarks is the Gateway of India, a majestic arch overlooking the Arabian Sea, which serves as a symbol of the city's colonial past. Nearby, the historic Chhatrapati Shivaji Maharaj Terminus, a UNESCO World Heritage Site, stands as a magnificent example of Victorian Gothic architecture, bustling with the constant flow of commuters.

                    <br><br>
                    Mumbai is also renowned for its thriving entertainment industry, with Bollywood at its heart. Visitors can explore Film City, where countless Bollywood blockbusters have been produced, or take a behind-the-scenes tour of iconic film studios. The city's vibrant nightlife offers an array of options, from trendy rooftop bars overlooking the skyline to lively street food markets serving mouthwatering delicacies.

                    <br><br>
                   For those seeking spiritual solace, Mumbai boasts a myriad of temples, mosques, churches, and synagogues, reflecting its multicultural fabric. The Haji Ali Dargah, a revered Islamic shrine located on a tiny islet in the Arabian Sea, attracts pilgrims and tourists alike with its stunning architecture and tranquil ambiance.
			 
				</p>
				
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d234404.4149774597!2d72.71637358589005!3d19.08217751290191!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c6306644edc1%3A0x5da4ed8f8d648c69!2sMumbai%2C%20Maharashtra!5e1!3m2!1sen!2sin!4v1710264379733!5m2!1sen!2sin" width="600" height="700" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>				</iframe>
			</div>

			<div>
				<h1> <center>Mumbai highlights</center> </h1>

				<p style="margin:20px 100px; font-size:18px;">
					<center>Mumbai's bustling markets, such as Colaba Causeway and Crawford Market, offer a sensory overload of sights, sounds, and smells. Visitors can shop for everything from traditional textiles and handicrafts to cutting-edge fashion and electronics.
                         Meanwhile, the city's culinary scene is a food lover's paradise, with a tantalizing array of street food stalls, fine dining restaurants, and local eateries serving up authentic flavors from across India and beyond.</center>
				</p>

				<br><br><br>
                <iframe width="100%" height="530" src="https://www.youtube.com/embed/tWD_-Rzrn8o" title="Mumbai: India&#39;s Transforming MEGACITY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>			</div>

			<div class="sub-amd">
				<p><center>
					<br><br>
                    Mumbai is a city of contrasts, where ancient traditions coexist with modernity, and where every street corner tells a story. From its iconic landmarks to its hidden gems, Mumbai invites travelers to embark on a journey of discovery and experience the vibrant tapestry of Indian culture.
                </center>
				</p>
			</div>
	...
	<section class="container2">
      <div class="card_outer2">
        <div class="card2">
          <div class="content2">
            <h2 class="title2">Bangalore</h2>
            <p class="copy2">Bangalore, India's Silicon Valley, teems with innovation and technological prowess.</p>
            <button class="btn2"><a href="Bangalor.php">Read More</a></button>
          </div>
        </div>
        <div class="card2">
          <div class="content2">
            <h2 class="title2">Ooty</h2>
            <p class="copy2">Enjoy panoramic views from Doddabetta Peak, the highest point in the Nilgiris.</p>
            <button class="btn2"><a href="Ooty.php">Read More</a></button>
          </div>
        </div>
        <div class="card2">
          <div class="content2">
		...
		<div class="card2">
          <div class="content2">
            <h2 class="title2">Kolkata</h2>
            <p class="copy2"> The "City of Joy," captivates with its rich history, culture, and bustling streets.</p>
            <button class="btn2"><a href="Kolkata.php">Read More</a></button>
          </div>
        </div>
      </div>
    </section>
