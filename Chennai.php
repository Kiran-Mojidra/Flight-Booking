...
<div class="main-slid-img">
    <div class="slid-img">
	<video src="Videos/chennai.webm" muted autoplay loop></video>
        <div class="intro">
                <h1>Chennai: Bask in the golden sands of  <br>Marina Beach, one of the longest <br>urban beaches in the world.</h1>
...
.card2:nth-child(4):before {
  background-image: url(Images/kutch.webp);
}
...
document.addEventListener('DOMContentLoaded', function() {
      ...
      textBox2.value = 'Chennai,Tamil Nadu';
    });
...
<div class="ahemdabad-content">
	<div class="amd-city-main">
			<h1>
				Book a flight to Chennai with Us
			</h1>
			<div class="sub-amd">
				<p>
					<br><br>
					Chennai, formerly known as Madras, is a bustling metropolis on the southeastern coast of India, renowned for its rich cultural heritage, vibrant traditions, and stunning coastal landscapes. As the capital city of Tamil Nadu, Chennai seamlessly blends its ancient past with modernity, offering visitors a plethora of experiences to cherish.

                    <br><br>
                    One of the city's main attractions is Marina Beach, stretching along the Bay of Bengal and considered one of the longest urban beaches globally, where locals and tourists alike gather to enjoy leisurely walks, indulge in delicious street food, and witness breathtaking sunsets against the backdrop of towering skyscrapers.

                    <br><br>
                    For history enthusiasts, Chennai boasts an array of architectural wonders, including the iconic Kapaleeshwarar Temple in Mylapore, adorned with intricate Dravidian-style carvings and dedicated to Lord Shiva. Fort St. George, constructed by the British East India Company in the 17th century, stands as a testament to Chennai's colonial past and houses historical artifacts and exhibits.				 
				</p>
				
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d241630.30463381275!2d80.04419860854908!3d13.047473316498966!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5265ea4f7d3361%3A0x6e61a70b6863d433!2sChennai%2C%20Tamil%20Nadu!5e1!3m2!1sen!2sin!4v1710341815143!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>				</iframe>
			</div>

			<div>
				<h1> <center>Chennai highlights</center> </h1>

				<p style="margin:20px 100px; font-size:18px;">
					<center>
                    The city's cultural scene is vibrant and diverse, with numerous music and dance festivals celebrating the classical arts of Bharatanatyam and Carnatic music. Visitors can explore institutions like the Kalakshetra Foundation, dedicated to preserving and promoting Indian classical dance forms, and witness captivating performances by renowned artists. 
                    </center>

				<br><br><br>
                <iframe width="100%" height="530" src="https://www.youtube.com/embed/Q8O9vUG4d2s" title="Chennai 4k drone view | Detroit of Asia | Explore Chennai | Explore the world" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>			</div>

			<div class="sub-amd">
				<p><center>
					<br><br>
                    Chennai's culinary landscape is equally enticing, offering a delectable array of South Indian delicacies, from crispy dosas and fluffy idlis to aromatic biryanis and spicy seafood dishes. Food enthusiasts can embark on a gastronomic journey through bustling markets like T Nagar and George Town, sampling local street food and savoring the flavors of authentic Tamil cuisine.				</center>
				</p>
			</div>
      ...
      <div class="card2">
        ...
        <div class="card2">
          <div class="content2">
            ...
            <p class="copy2">Experience the vibrant culture of Ahmedabad during the annual International Kite Festival.</p>
        ...
        <div class="card2">
          <div class="content2">
            <h2 class="title2">Kutch</h2>
            <p class="copy2"> Explore the Rann of Kutch, the world's largest salt desert.</p>
            <button class="btn2"><a href="Kutch.php">Read More</a></button>
          </div>
        </div>
