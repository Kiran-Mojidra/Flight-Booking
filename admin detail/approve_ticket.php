...
if (isset($_GET['delete_id'])) {
    ...
    if (mysqli_query($conn, $delete_query)) {
        ...
        echo "<script>window.location.href = 'approve_ticket.php';</script>";
    } else {
        echo "<script>alert('Error deleting record: " . mysqli_error($conn) . "');</script>";
    }
}

$query = "SELECT * FROM pass_details WHERE status = 'approved'"; 
...
<table class="user-detail2" id="adminTable"> 
	<tr> 
		<th colspan="12"><h2>All Approved Ticket Booking</h2></th> <!-- Changed colspan to 3 -->
	</tr> 
