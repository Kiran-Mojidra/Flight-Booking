<footer class="fo">
  <div class="footer-container">
    <div class="footer-nav">
      <div class="footer-link">
        <ul>
          ...
          <li><a href="flightschedule.php"> Add Flight Schedule</a></li>
          <li><a href="pending_ticket.php">Pending Tickets</a></li>
						...
						<li><a href="trefund.php">Ticket Refund</a></li>
        </ul>
      </div>
      <div class="footer-link">
        <ul>
            ...
            <li><a href="hotel.php">Add Hotel</a></li>
						...
						<li><a href="hrefund.php">Hotel Refund</a></li>
        </ul>
      </div>
      <div class="footer-link">
        <ul>
        <li><a href="contact.php">Enquiry</a></li>
          ...
          <li><a href="av_hotel.php">Available Hotels</a></li>
          <li><a href="schedule.php">Scheduled Flights</a></li>

          <li><a href="airline.php">Available Airlines</a>
         
        </ul>
      </div>
     
     <!-- <div class="footer-content">
        <div class="logo"> <svg viewBox='410.1386 361.7521 54.723 33.7621' width='50' height='30.84818083803885' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' preserveAspectRatio='none'>
                        <defs></defs>
    ...
    <div class="copyrights">
      ...
      <p>
        copyright
        <i class="bi bi-c-circle"> 2024 Udaan.com™. All rights reserved.</i>
        <br>
...
/* Remove the margin-top for the copyright section */
...
.footer-container .copyrights hr {
  width: 90%;
  margin: 20px auto;
}
