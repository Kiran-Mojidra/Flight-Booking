...
if (isset($_GET['approve_id'])) {
    ...
    $approve_query = "UPDATE pass_details SET status = 'approved' WHERE id = '$approve_id'";
    if (mysqli_query($conn, $approve_query)) {
        ...
        echo "<script>window.location.href = 'pending_ticket.php';</script>";
    } else {
...
if (isset($_GET['cancel_id'])) {
    ...
    $cancel_query = "UPDATE pass_details SET status = 'cancelled' WHERE id = '$cancel_id'";
...
$query = "SELECT * FROM pass_details WHERE status = 'pending'"; 
