...
<div class="main-slid-img">
    <div class="slid-img">
	<video src="Videos/kolkata.mp4" muted autoplay loop></video>
        <div class="intro">
                <h1>Kolkata:Explore the vibrant cultural <br> hub of Park Street, renowned <br>for its buzzing nightlife, <br> live music, and iconic eateries.</h1>
...
.card2:nth-child(1):before {
  background-image: url(Images/taj_hotel.jpg);
}
                        ...
                        <ul class="option2" id="toOptions" name="to1">
                           ...
                           <li>
                                    <div class="makeFlex hrtlCenter">
                                        <img class="icLocAlt appendRight8" src="Icons/ic-flight-onward.png" alt="icon">
                                        <div class="calc60">
                                            <p class="font14 appendBottom5 blackText">Kolkata, West Bengal</p>
                                            <p class="font12 greyText appendBottom3"> Netaji Subhas Chandra Bose International Airport</p>
                                        </div>
                                        <div class="pushRight font14 lightGreyText latoBold con">CCU</div>
                                    </div>
                                </li>
...
document.addEventListener('DOMContentLoaded', function() {
      ...
      textBox2.value = 'Kolkata, West Bengal';
    });
...
<div class="ahemdabad-content">
	<div class="amd-city-main">
			<h1>
				Book a flight to Kolkata with Us
			</h1>
			<div class="sub-amd">
				<p>
					<br><br>
					Kolkata, the cultural capital of India, is a city steeped in history, art, and literature, offering travelers a captivating blend of old-world charm and modern dynamism. Situated on the eastern banks of the Hooghly River, Kolkata is renowned for its colonial architecture, bustling markets, and vibrant festivals that celebrate its rich heritage.

          <br><br>
          A visit to Kolkata is incomplete without exploring its iconic landmarks, such as the Victoria Memorial, a grand marble monument dedicated to Queen Victoria, and the majestic Howrah Bridge, an engineering marvel that connects the city with its bustling suburbs. The narrow lanes of North Kolkata's Kumartuli district are a treasure trove for art enthusiasts, where skilled artisans craft exquisite clay idols for the city's renowned Durga Puja festival.

          <br><br>
          Kolkata's culinary scene is equally legendary, with its mouthwatering array of street food delights and traditional Bengali cuisine. From savory snacks like phuchka and kathi rolls to delectable sweets like rasgulla and sandesh, the city's culinary offerings are sure to tantalize the taste buds of visitors.				 
				</p>
				
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d114547.28232460523!2d88.26495100072154!3d22.53540637453306!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f882db4908f667%3A0x43e330e68f6c2cbc!2sKolkata%2C%20West%20Bengal!5e1!3m2!1sen!2sin!4v1710269027878!5m2!1sen!2sin" width="600" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>				</iframe>
			</div>

			<div>
				<h1> <center>Kolkata highlights</center> </h1>

				<p style="margin:20px 100px; font-size:18px;">
					<center>
          Kolkata's cultural calendar is replete with events and festivals that showcase its vibrant spirit. The annual Durga Puja festival, celebrated with great fervor across the city, transforms Kolkata into a spectacle of lights, colors, and festivities, attracting millions of visitors from around the world. 
          </center>

				<br><br><br>
        <iframe width="100%" height="530" src="https://www.youtube.com/embed/tYY4WnfEEkY" title="KOLKATA : THE THIRD EYE |  Drone documentary | 4K" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>

			<div class="sub-amd">
				<p><center>
					<br><br>
          Kolkata is a city that exudes warmth, charm, and a unique sense of nostalgia, inviting travelers to immerse themselves in its rich tapestry of history, culture, and tradition. A visit to Kolkata promises an unforgettable journey through the heart and soul of India's cultural heritage.
        </center>
				</p>
			</div>
	...
	<section class="container2">
      <div class="card_outer2">
        <div class="card2">
          <div class="content2">
            <h2 class="title2">Mumbai</h2>
            <p class="copy2">Wander through the historic lanes of Colaba and soak in the colonial architecture.</p>
            <button class="btn2"><a href="Mumbai.php">Read More</a></button>
          </div>
        </div>
        <div class="card2">
          <div class="content2">
		...
		<div class="card2">
          <div class="content2">
            ...
            <p class="copy2">Bangalore, known as the Silicon Valley of India, is a hub for technology and innovation.</p>
