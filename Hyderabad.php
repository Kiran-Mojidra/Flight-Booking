...
<div class="main-slid-img">
    <div class="slid-img">
	<video src="Videos/hydrabad.mp4" muted autoplay loop></video>
        <div class="intro">
                <h1>Hyderabad: The iconic Charminar stands <br>as a symbol of Hyderabad's rich heritage.</h1>
...
document.addEventListener('DOMContentLoaded', function() {
      ...
      textBox2.value = 'Hyderabad,Telangana';
    });
...
<div class="ahemdabad-content">
	<div class="amd-city-main">
			<h1>
				Book a flight to Hyderabad with Us
			</h1>
			<div class="sub-amd">
				<p>
					<br><br>
                    Hyderabad, known as the "City of Pearls" and the "City of Nizams," is a captivating blend of old-world charm and modernity, offering visitors a glimpse into its rich cultural heritage and vibrant urban life.

                    <br><br>
                    At the heart of Hyderabad lies the iconic Charminar, a majestic monument that has become synonymous with the city. This architectural marvel, built in the 16th century by Sultan Muhammad Quli Qutb Shah, stands as a symbol of Hyderabad's glorious past and serves as a bustling hub of activity, surrounded by bustling markets and narrow lanes.

                    <br><br>
                    Nearby, the historic Golconda Fort, with its imposing ramparts and breathtaking views, offers a glimpse into the city's royal legacy. The Qutb Shahi Tombs, nestled amidst tranquil gardens, pay homage to the city's founding dynasty and showcase exquisite Persian-inspired architecture.
                </p>
				
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d236667.8608828202!2d78.24323280516853!3d17.412281015964357!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb99daeaebd2c7%3A0xae93b78392bafbc2!2sHyderabad%2C%20Telangana!5e1!3m2!1sen!2sin!4v1710341206769!5m2!1sen!2sin" width="600" height="500" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>            </iframe>
			</div>

			<div>
				<h1> <center>Hyderabad highlights</center> </h1>

				<p style="margin:20px 100px; font-size:18px;">
					<center>
                    Beyond its historic landmarks and culinary delights, Hyderabad embraces modernity with its booming IT industry, gleaming skyscrapers, and upscale malls. Yet, amidst the urban sprawl, pockets of serenity can be found in lush parks like Lumbini Park and the picturesque Hussain Sagar Lake, where visitors can relax and unwind amidst natural beauty.
                    </center>
				</p>

				<br><br><br>
                <iframe width="100%" height="530" src="https://www.youtube.com/embed/EGdQ5QsHlcA" title="Hyderabad city 4k drone view | City of Pearls | Explore Hyderabad| Explore The World" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>            </div>

			<div class="sub-amd">
				<p><center>
					<br><br>
                    Hyderabad's culinary scene is as diverse as its cultural heritage, with its world-renowned Hyderabadi biryani tantalizing taste buds with its aromatic spices and rich flavors. From traditional street food delights like kebabs and haleem to fine dining experiences at iconic restaurants, Hyderabad promises a culinary journey like no other.
                    </center>
                </p>
			</div>
      ...
      <div class="card_outer2">
        ...
        <div class="card2">
          <div class="content2">
            ...
            <p class="copy2">Bask in the golden sands of Marina Beach, one of the longest urban beaches in the world.</p>
		...
		<div class="card2">
          <div class="content2">
            ...
            <p class="copy2"> Home to the iconic Taj Mahal, a UNESCO World Heritage Site.</p>
