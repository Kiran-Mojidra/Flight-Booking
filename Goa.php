...
<div class="main-slid-img">
    <div class="slid-img">
	<video src="Videos/goa.mp4" muted autoplay loop></video>
        <div class="intro">
                <h1>Goa: Sun-kissed beaches with <br>golden sands and azure waters.</h1>
...
<div class="ahemdabad-content">
	<div class="amd-city-main">
			<h1>
				Book a flight to Goa with Us
			</h1>
			<div class="sub-amd">
				<p>
					<br><br>
          Goa, nestled along the pristine shores of the Arabian Sea on India's west coast, is a mesmerizing blend of natural beauty, cultural heritage, and vibrant energy. Renowned for its sun-kissed beaches, Goa offers a tropical paradise for travelers seeking relaxation and adventure alike. The coastline stretches for miles, adorned with palm-fringed beaches where golden sands meet crystal-clear waters, inviting visitors to bask in the warm sunshine or indulge in thrilling water sports.

          <br><br>
          Beyond its stunning coastline, Goa's rich history and heritage add depth to its allure. The influence of Portuguese colonial rule is evident in its architecture, with majestic churches, cathedrals, and forts dotting the landscape. Explore the cobbled streets of Old Goa to discover charming colonial buildings and immerse yourself in the region's fascinating past.	
        </p>
				
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d478372.2657418544!2d73.67703172528542!3d15.349486357374339!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bbfba106336b741%3A0xeaf887ff62f34092!2sGoa!5e1!3m2!1sen!2sin!4v1710272085836!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>			</div>

			<div>
				<h1> <center>Goa highlights</center> </h1>

				<p style="margin:20px 100px; font-size:18px;">
					<center>
          As the sun sets, Goa comes alive with a vibrant nightlife scene. From bustling beach clubs to lively night markets, there's no shortage of entertainment options. Sample delicious seafood at beachside shacks, dance to the rhythms of live music, or simply stroll along the moonlit shores under a star-studded sky.                    </center>        
                </p>

				<br><br><br>
        <iframe width="100%" height="530" src="https://www.youtube.com/embed/cBbS8Pi0obo" title="Goa 4k India - Travel Film - Travel India  - Goa India travel 4k" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>            </div>

			<div class="sub-amd">
				<p><center>
					<br><br>
          Goa is not just a destination; it's an experience that captivates the senses and leaves a lasting impression. Whether you're seeking relaxation, adventure, or cultural immersion, Goa offers something for every traveler, making it a must-visit destination for those craving an unforgettable escape.                </center>
				</p>
			</div>
