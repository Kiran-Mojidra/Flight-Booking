...
<div class="main-slid-img">
    <div class="slid-img">
	<video src="Videos/agra.mp4" muted autoplay loop></video>
        <div class="intro">
                <h1>Agra: Home to the iconic Taj Mahal,<br> a UNESCO World Heritage Site.</h1>
                           ...
                           <!-- gujarat air-->
                                ...
                                <li>
                                    <div class="makeFlex hrtlCenter">
                                        <img class="icLocAlt appendRight8" src="Icons/ic-flight-onward.png" alt="icon">
                                        <div class="calc60">
                                            <p class="font14 appendBottom5 blackText">Agra, Uttar Pradesh</p>
                                            <p class="font12 greyText appendBottom3"> Agra Airport</p>
                                        </div>
                                        <div class="pushRight font14 lightGreyText latoBold">AGR</div>
                                    </div>
                                </li>
                      </ul>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
      ...
      textBox2.value = 'Agra, Uttar Pradesh';
    });
...
<div class="ahemdabad-content">
	<div class="amd-city-main">
			<h1>
				Book a flight to Agra with Us
			</h1>
			<div class="sub-amd">
				<p>
					<br><br>
                    Agra, nestled on the banks of the Yamuna River in the northern state of Uttar Pradesh, is a city steeped in rich history and architectural marvels. At the heart of Agra lies the magnificent Taj Mahal, an enduring symbol of love and one of the Seven Wonders of the World. Built by Emperor Shah Jahan in memory of his beloved wife Mumtaz Mahal, this pristine white marble mausoleum is a masterpiece of Mughal architecture, captivating visitors with its ethereal beauty, intricate carvings, and perfectly symmetrical design.

                    <br><br>
                    Adjacent to the Taj Mahal stands the imposing Agra Fort, a UNESCO World Heritage Site and a testament to the grandeur of the Mughal Empire. This formidable red sandstone fortress served as the residence of the Mughal emperors for generations and houses a wealth of palaces, mosques, and gardens within its fortified walls.	
                </p>
				
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d110326.20640053462!2d77.89761136343726!3d27.17615042456752!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39740d857c2f41d9%3A0x784aef38a9523b42!2sAgra%2C%20Uttar%20Pradesh!5e1!3m2!1sen!2sin!4v1710342333694!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>			</div>

			<div>
				<h1> <center>Agra highlights</center> </h1>

				<p style="margin:20px 100px; font-size:18px;">
					<center>
                    Beyond the iconic landmarks, Agra boasts a rich tapestry of cultural heritage and vibrant bazaars. Explore the bustling lanes of the old city, where centuries-old traditions come alive in the bustling markets offering a kaleidoscope of handicrafts, textiles, and culinary delights. Sample the city's culinary delights, from mouthwatering Mughlai cuisine to delectable street food delights like petha and chaat.                    </center>

				<br><br><br>
                <iframe width="100%" height="530" src="https://www.youtube.com/embed/3QHoMnuSMUY" title="Agra City | आगरा शहर का ऐसा वीडियो पहले कभी नहीं देखा होगा | Agra" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>                </div>

			<div class="sub-amd">
				<p><center>
					<br><br>
                    For history enthusiasts, a visit to Fatehpur Sikri is a must. Just a short drive from Agra, this UNESCO-listed ghost city was once the capital of the Mughal Empire before being abandoned due to water scarcity. Today, its well-preserved red sandstone structures, including the Jama Masjid, Buland Darwaza, and Panch Mahal, offer a fascinating glimpse into the empire's golden era.                	</center>
				</p>
			</div>
      ...
      <div class="card_outer2">
        ...
        <div class="card2">
          <div class="content2">
            ...
            <p class="copy2">The iconic Charminar stands as a symbol of Hyderabad's rich heritage.</p>
        ...
        <div class="card2">
          <div class="content2">
            ...
            <p class="copy2"> Charming beach shacks serving refreshing cocktails and snacks.</p>
